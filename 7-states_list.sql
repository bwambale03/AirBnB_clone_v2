...
CREATE USER IF NOT EXISTS 'hbnb_dev'@'localhost' IDENTIFIED BY 'HBNB_MYSQL_HASH';
ALTER USER 'hbnb_dev'@'localhost' IDENTIFIED BY 'HBNB_MYSQL_HASH';
...
('541a55f4-7d82-47d9-b54c-a76916479556',
  ...
  '2017-03-25 19:42:40','2017-03-25 19:42:40',
  'Napa','421a55f4-7d82-47d9-b54c-a76916479547'
